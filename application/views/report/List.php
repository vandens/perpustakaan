...
<?php echo form_open('report/denda'); ?>
<table>
...
<option value='judul'>Peminjam</option>
<option value='pengarang'>Judul Buku</option>
</select>
...
<br/>
<div id='isi'>
 <a href="report" onclick="PopUp(this.href);return false"><img src="<?php echo base_url('media/img/12.png'); ?>"> Cetak</a>
 <div id='nav'>
	<?php echo $paginator; ?>
</div>
...
<table border='0px' width='100%' class='TableContent'>
	...
	<tr id='TableHover' class='<?php echo $warna; ?>' align='center'>
		...
		<td><?php echo $this->AppModel->tgl_indo($dp['tgl_kembali']); ?></td>
		<td><?php echo $flag;?></td>
