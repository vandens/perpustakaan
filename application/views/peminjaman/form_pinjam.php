...
<table width="100%" width="100%">
     <tr>
          <td width="300px">Id Peminjaman</td><td><input type='text' name='id' id='id' class='input span2' value='Auto Generate' disabled='disabled'></td>
     </tr>
     <tr>
          <td>Peminjam</td><td>
          <select name='user' id='user'>
               ...
               <?php 
				$q = $this->AppModel->manualQuery("SELECT * FROM tb_user where status != '1'");
