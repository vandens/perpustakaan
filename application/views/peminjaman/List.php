...
<br/>
<div id='isi'>
 <a href="peminjaman/tambah" onclick="PopUp(this.href);return false"><img src="<?php echo base_url('media/img/add.png'); ?>"> Tambah Peminjaman</A>
<div id='nav'>
	<?php echo $paginator; ?>
</div>
...
<table border='0px' width='100%' class='TableContent'>
	...
	<tr id='TableHover' class='<?php echo $warna; ?>' align='center'>
		...
		<td width='100px'><?php echo $this->AppModel->tgl_indo($dp['tgl_order']); ?></td>
